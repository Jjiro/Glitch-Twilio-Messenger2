...
#Adding Twilio client to this app --done
...
def get_sent_messages():
    # TODO: Make this return a collection of messages that were sent from the number --done
    messages = []  #client.messages.list(from_=TWILIO_PHONE_NUMBER)  # this shows all the messages sent from this number
    return messages

def send_message(to, body):
    # TODO: Send the text message --done
