...
##STEPS TO RUN IN TERMINAL BEFORE USING APP
Go to Tools > Logs > Console: enter 'source ./.venv/bin/activate' to activate, 'refresh'+enter, 'pip freeze > requirements.txt' then  'refresh'+enter